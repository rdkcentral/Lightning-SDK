...
console.log(
  chalk.red('The ' + chalk.italic('start') + ' script has been removed from the Lightning-SDK ... ')
)
console.log()
...
console.log()
console.log(
  'And then run ' + chalk.green.bold('lng dev') + ' in the directory with your Lightning App'
)
